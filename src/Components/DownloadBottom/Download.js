    ...
    <div className="pt-5">
      ...
      <div className="container">
        <img
          src={triangleBg}
          alt=""
          className="triangle_bg overflow-y-hidden"
        />
        <div className="row triangleBg">
          <div className="col-lg-6 col-sm-12 pt-5 d-flex flex-column justify-content-center ">
            <div className="pb-5">
              <div className="hiw_heading fw-bold px-3 py-2 fs-6 ">
                Download
              </div>
            </div>
            <div className="">
              ...
              <div className="d-flex flex-row pt-4 gap-3  ">
